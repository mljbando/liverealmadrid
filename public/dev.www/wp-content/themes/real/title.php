 ...
 */
/*
Template Name: 獲得タイトルページ用テンプレート
*/
?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja" dir="ltr" xmlns:og="http://ogp.me/ns#" xmlns:mixi="http://mixi-platform.com/ns#" xmlns:fb="http://www.facebook.com/2008/fbml" dir="ltr" lang="ja">
<head>
...
<link rel="stylesheet" type="text/css" href="/title_img_css/css/title.css" />
...
<?php
$posts = get_posts('include=4&post_type=page');
