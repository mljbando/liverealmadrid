...
<?php echo do_shortcode( '[table-while id=4 key="LG"/]' );  ?>

// デフォルトでは最初のカラムを表示しているので
// 非表示にする場合は"key_disp=0"を追記
<?php echo do_shortcode( '[table-while id=4 key="LG" key_disp=0/]' );  ?>
*/
?>
...
<div id="ALL">
<?php echo do_shortcode( '[table id=65 key="ALL" /]' ); ?>
</div>
</div>
...
<div id="LG">
<?php echo do_shortcode( '[table-while id=65 key="LG" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="CL">
<?php echo do_shortcode( '[table-while id=65 key="CL" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="CO">
<?php echo do_shortcode( '[table-while id=65 key="CO" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="FM">
<?php echo do_shortcode( '[table-while id=65 key="FM" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="temporada">
<ul>
<li><a href="match1920">2019-20</a></li>
