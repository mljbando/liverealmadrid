...
<div id="ALL">
<?php echo do_shortcode( '[table id=56 key="ALL" /]' ); ?>
</div>
</div>
...
<div id="LG">
<?php echo do_shortcode( '[table-while id=56 key="LG" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="CL">
<?php echo do_shortcode( '[table-while id=56 key="CL" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="CO">
<?php echo do_shortcode( '[table-while id=56 key="CO" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="FM">
<?php echo do_shortcode( '[table-while id=56 key="FM" key_disp=1 /]' ); ?>
</div>
</div>
