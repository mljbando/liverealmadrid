...
<div id="ALL">
<?php echo do_shortcode( '[table id=58 key="ALL" /]' ); ?>
</div>
</div>
...
<div id="LG">
<?php echo do_shortcode( '[table-while id=58 key="LG" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="CL">
<?php echo do_shortcode( '[table-while id=58 key="CL" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="CO">
<?php echo do_shortcode( '[table-while id=58 key="CO" key_disp=1 /]' ); ?>
</div>
</div>
...
<div id="FM">
<?php echo do_shortcode( '[table-while id=58 key="FM" key_disp=1 /]' ); ?>
</div>
</div>
